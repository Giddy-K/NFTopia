...
contract AVAXGods is ERC1155, Ownable, ERC1155Supply {
    ...
    uint256 public tokensMinted; // Total number of tokens minted
    uint256 internal _totalSupply; // New variable to track total supply
    ...
    ) ERC1155(_metadataURI) Ownable(msg.sender) {
    ...
    function _update(
        ...
        super._update(from, to, ids, amount);
    }
}
